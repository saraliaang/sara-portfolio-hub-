...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    problemSpace: 'Traditional portfolios feel static and forgettable, and they fail to convey personality and motion.',
    designIntent: 'Build an immersive, story-driven, gesture-led interface where exploration replaces scrolling.',
    technicalExecution: 'Gesture-ready interaction layer.\nCustom cursor physics.\nAnimated map narrative.\nGlass UI systems.',
    futureHorizon: 'Connect live gesture input, expand worlds, and ship interactive case studies.',
  ...
  },
  {
    ...
    futureHorizon: 'Evolving Gesture Lab into a reusable interaction framework that powers gesture-controlled navigation, storytelling, and portfolio experiences, including this hub.',
